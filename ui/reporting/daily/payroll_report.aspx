<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="payroll_report.aspx.cs" Inherits="daily_payroll_report" Title="Payroll Report | SecurTime" EnableEventValidation="false" %>

<asp:Content ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">REPORTING</small> / <small class="current-section">DAILY</small> / <span class="current-page">PAYROLL REPORT</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<asp:Content ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/reporting/daily/payroll_report.js"></script>
</asp:Content>