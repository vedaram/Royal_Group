<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="performance_in_out_report.aspx.cs" Inherits="daily_performance_in_out_report" Title="Daily Performance In Out Report | SecurTime" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="saxMasterPageTitle" Runat="Server">
<div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">REPORTING</small> / <small class="current-section">DAILY</small> / <span class="current-page">PERFORMANCE IN OUT REPORT</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<link rel="stylesheet" href="../../../resources/css/datepicker.css">
    ...
    <script type="text/javascript" src="../../../resources/js/reporting/daily/performance_in_out_report.js"></script>
</asp:Content>
