...
public partial class daily_performance_report : System.Web.UI.Page
{
    const string page = "DAILY_PERFORMANCE_REPORT";
    ...
    private void PrepareDataForExport(string filters, string branches)
    {
        ...
        string
            ...
            where_clause = string.Empty, company_name ,  employee_status,
            department_name, shift_name, category_name ,  branch_list = string.Empty;
    ...
    private DataTable GetFilteredData()
    {
        ...
        query = "select TOP " + export_limit + " PDate, Emp_ID, Emp_Name,cat_name,employee_category ,   Shift_In, In_Punch, Out_Punch, Shift_Out, WorkHRs, Status, OT, LateBy, EarlyBy from DailyPerformancereport1";
    ...
    public static ReturnObject DoExport(string filters, string branches)
    {
        ...
        daily_performance_report page_object = new daily_performance_report(); // instance of the page to access non static methods.
        ReturnObject return_object = new ReturnObject();
        DataTable filtered_data = new DataTable();
        JObject filters_data = new JObject();
