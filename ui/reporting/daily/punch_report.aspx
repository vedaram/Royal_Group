<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="punch_report.aspx.cs" Inherits="daily_punch_report" Title="Daily Punch Report | SecurTime" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="saxMasterPageTitle" Runat="Server">
 <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">REPORTING</small> / <small class="current-section">DAILY</small> / <span class="current-page">PUNCH REPORT</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="saxMasterPageFooter" Runat="Server">
    ...
    <script type="text/javascript" src="../../../resources/js/reporting/daily/punch_report.js"></script>
</asp:Content>
