<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="leave_card.aspx.cs" Inherits="employee_leave_card" Title="Leave Card Report | SecurTime" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">REPORTING</small> / <small class="current-section">EMPLOYEE</small> / <span class="current-page">LEAVE CARD</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/reporting/employee/leave_card.js" ></script>
