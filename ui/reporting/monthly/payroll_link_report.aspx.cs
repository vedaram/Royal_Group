...
public partial class monthly_payroll_link_report : System.Web.UI.Page
{
    const string page = "PAYROLL_LINK_REPORT";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            message = "An error occurred while loading PayRoll Link Report. Please try again. If the error persists, please contact Support.";
    ...
    public static ReturnObject GetOtherData(string company_code)
    {
        ...
        catch (Exception ex)
        {
            ...
            Logger.LogException(ex, page, "GET_COMPANY_RELATED_DATA");
    ...
    private DataTable PrepareDataForExport(string filters)
    {
        ...
        string
            ...
            branch_name, department_name, shift_name,category_name ,  employee_status,
            employee_id, employee_name, query, month, year;
        ...
        filter_conditions.Add("fdate", from_date);
        filter_conditions.Add("tdate", to_date);
        db_connection.ExecuteStoredProcedureWithHashtable_WithoutReturn("PayRollLinkReportFilter", filter_conditions);
        ...
        //{
        //    case 0:
        //        where_clause += " and EmpId in (select distinct(Emp_Code) from EmployeeMaster where Emp_Status=1)";
        //        break;
        //    case 1:
        //        where_clause += " and EmpId in (select distinct(Emp_Code) from EmployeeMaster where (managerId='" + current_user_id + "' or Emp_Code='" + current_user_id + "') and Emp_Status=1)";
        //        break;
        //    default:
        //        where_clause += " and EmpId ='" + current_user_id + "'";
        //        break;
        //}

        if (company_name != "select")
        {
          //  where_clause = where_clause + " and CompName = '" + company_name + "'";
            ...
            if (shift_name != "select")
                where_clause = where_clause + " and ShiftName = '" + shift_name + "'";


            if (category_name != "select")
                where_clause = where_clause + " and ShiftName ='" + category_name + "'";
        ...
        db_connection.ExecuteStoredProcedureWithHashtable_WithoutReturn("PayRolllinkReportFilter1", filter_conditions);

        query = "select * from payrolllinkreport1";
    ...
    public static ReturnObject DoExport(string filters)
    {
        ...
        monthly_payroll_link_report page_object = new monthly_payroll_link_report(); // instance of the page to access non static methods.
        ReturnObject return_object = new ReturnObject();
        DataTable filtered_data = new DataTable();
