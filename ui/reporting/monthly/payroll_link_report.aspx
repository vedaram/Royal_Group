<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="payroll_link_report.aspx.cs" Inherits="monthly_payroll_link_report" Title="PayRoll Link Report | SecurTime" EnableEventValidation="false" %>

<asp:Content ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">REPORTING</small> / <small class="current-section">MONTHLY</small> / <span class="current-page">PAYROLL LINK REPORT</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<asp:Content ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/reporting/monthly/payroll_link_report.js"></script>
</asp:Content>