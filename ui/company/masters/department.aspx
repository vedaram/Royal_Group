<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="department.aspx.cs" Inherits="masters_department" Title="Department Master | SecurTime" EnableEventValidation="false"%>

<asp:Content ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">MASTERS</small> / <span class="current-page">DEPARTMENT MASTER</span>
            </div>
        </div>
        <!-- /.pull-left -->
        <div class="pull-right">
            <div class="action-bar">
                <a class="btn btn-blue" data-toggle="modal" data-target="#saveDialog" data-role="department/add">
                ...
                <button class="btn btn-blue" id="exportButton" data-control="button" data-role="department/export">
...
<asp:Content ContentPlaceHolderID="saxMasterPageContent" runat="server">
    ...
    <div class="container" id="listView">
        ...
        <div class="text-center">
            <button class="btn pagination" id="paginationButton" data-control="button" data-role="department/more">
                load more data
            </button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you would like to delete this department?</p>
                </div>
                <!-- /.modal-body -->
                <div class="modal-footer">
                    <a href="javascript:void(0);" class="btn text-red" data-control="close" data-dismiss="modal" data-target="#deleteDialog">Cancel</a>
                    <button class="btn btn-blue" id="deleteButton" data-control="button" data-role="department/delete" data-loading-text="Processing ...">Proceed</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-blue" id="saveButton" data-control="button" data-loading-text="Saving ...">Save Department</button>
                </div>
                <!-- /.modal-footer -->
            </div>
            <!-- /.modal-content -->
...
<asp:Content ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    <script type="text/javascript" src="../../../resources/js/company/department.js"></script>
</asp:Content>