<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="details.aspx.cs" Inherits="overtime_details" Title="Overtime Details | SecurTime" EnableEventValidation="false" %>

<asp:Content ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">TRANSACTION</small> / <span class="current-page">OVERTIME DETAILS</span>
            </div>
        </div>
        <!-- /.pull-left -->
...
<asp:Content ContentPlaceHolderID="saxMasterPageContent" runat="server">
	<div class="container">
		<div class="card no-padding">
			<div class="card-body">
				<table class="table width-12" cellpadding="0" cellspacing="0" id="overTimeApprovalTable">
                    <thead>
                        <tr>                            
                            <th>Employee ID</th> 
                            <th>Employee Name</th>
                ...
                <div class="form-group text-center hide">
	                <a href="javascript:void(0);" class="btn pagination" id="otPagination" title="Click here to load more data." data-control="button" data-role="load-more-ot-data">    
...
<asp:Content ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/transaction/overtime/details.js"></script>
</asp:Content>