<%@ Page Language="C#" MasterPageFile="~/layout/base.master" AutoEventWireup="true" CodeFile="approve.aspx.cs" Inherits="manual_approve" Title="Manual Punch Approval | SecurTime" EnableEventValidation="false" %>

<asp:Content ContentPlaceHolderID="saxMasterPageTitle" runat="server">
    <div class="container">
        <div class="pull-left">
            <div class="current-page-outer">
                <small class="current-section">TRANSACTION</small> / <span class="current-page">MANUAL PUNCH APPROVAL</span>
            </div>
        </div>
        <!-- /.pull-left -->
				...
				<div class="tab-content">
					<div class="tab-panel active">
				        ...
				        <table class="table width-12" cellpadding="0" cellspacing="0" id="ManualPunchTable">
			                <thead>
			                    <tr>
			                        <th><input type="checkbox" id="manualCheckAll"/></th>
			                        <th>Employee ID</th> 
			                        <th>Employee Name</th>                                
			                        <th>Work Date</th>
			                        <th>Out Date</th>
			            ...
			            <div class="form-group text-center hide">
				            <a href="javascript:void(0);" class="btn pagination" id="ManualPunchPagination" title="Click here to load more data." data-control="button" data-role="load-more-manual-punch-data">    
...
<asp:Content ContentPlaceHolderID="saxMasterPageFooter" runat="server">
    ...
    <script type="text/javascript" src="../../../resources/js/transaction/manual/approve.js"></script>
</asp:Content>