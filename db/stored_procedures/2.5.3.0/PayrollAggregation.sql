...
/****** Object:  StoredProcedure [dbo].[PayrollAggregation]    Script Date: 06/03/2016 15:31:59 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	--=====
	update  PayrollAggregationReport set overtime = ''  --    this issue to be fixed 2.5.4.0 
