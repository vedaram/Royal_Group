$(function () {
	...
	var Company = (function ($, w, d) {
		...
		function getCompanyData() {
			return SAXHTTP.AJAX(
				"leave_register.aspx/GetCompanyData", {}
			)
	...
	var OtherData = (function ($, w, d) {
		...
		function getOtherData(company_code) {
			...
			return SAXHTTP.AJAX(
					"leave_register.aspx/GetOtherData",
				...
				.done(function (data) {
		            ...
		            _render($designation, results.designation, 'designation_name', 'designation_name', 'Select Designation', 'No Designations found');
