$(function () {
	...
	var Company = (function ($, w, d) {
		...
		function getCompanyData() {
			return SAXHTTP.AJAX(
				"attendance_report.aspx/GetCompanyData", {}
			)
	...
	/************************************************************************************************************************************************/
		...
		function getOtherData(company_code) {
			...
			return SAXHTTP.AJAX(
					"attendance_report.aspx/GetOtherData",
...
//	            SAXAlert.show({'type': 'error', 'message': 'Please select a Status'});
//	            return false;
//	        }
		...
		function doExport() {
			...
			if (_validateFilters(filters_data)) {
				...
				SAXHTTP.AJAX(
						"attendance_report.aspx/DoExport",
