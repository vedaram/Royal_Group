$(function () {
	...
	var Company = (function ($, w, d) {
		...
		function getCompanyData() {
			return SAXHTTP.AJAX(
				"leave_report.aspx/GetCompanyData", {}
			)
	...
	var OtherData = (function ($, w, d) {
		...
		function getOtherData(company_code) {
			...
			return SAXHTTP.AJAX(
					"leave_report.aspx/GetOtherData",
					{company_code: company_code}
				)
				.done(function (data) {

					var results = JSON.parse(data.d.return_data);
					_render($designation, results.designation, 'designation_name', 'designation_name', 'Select Designation', 'No Designation found');
	...
	var Report = (function ($, w, d) {
		...
		function _validateFilters(data) {
	        ...
	        if (data.category == "select") {
	            SAXAlert.show({ 'type': 'error', 'message': 'Please select a Category' });
	            return false;
	        }
